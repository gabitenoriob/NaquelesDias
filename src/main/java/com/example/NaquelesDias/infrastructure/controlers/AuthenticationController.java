...
import com.example.NaquelesDias.infrastructure.DTOs.AuthenticationDTO;
import com.example.NaquelesDias.infrastructure.DTOs.LoginResponseDTO;
import com.example.NaquelesDias.infrastructure.DTOs.PasswordDTO;
import com.example.NaquelesDias.infrastructure.DTOs.RegisterDTO;
import com.example.NaquelesDias.model.user.*;
...
public class AuthenticationController {
    ...
    private static User createUser(User user, int biologicalInfoId, int addressInfoId) {
        ...
        return new User(user.getFirstname(), user.getLastname(), user.getCpf(), user.getEmail(),
                encryptedPassword, user.getRole(), biologicalInfoId, addressInfoId, user.getLevelOfEducation());
    }
